...
const OS_DEFAULT_PATHS: Record<Platform, { REPO_ROOT: string; HOST_REPO_ROOT: string; WORKTREE_ROOT: string }> = {
  linux: {
    REPO_ROOT: '/home/tim-175/repos',
    HOST_REPO_ROOT: '/home/tim-175/repos',
    WORKTREE_ROOT: '/home/tim-175/repos/Tree',
  },
  windows: {
    REPO_ROOT: 'C:\\repos',
    HOST_REPO_ROOT: 'C:\\repos',
    WORKTREE_ROOT: 'C:\\repos\\Tree',
  },
  mac: {
    REPO_ROOT: '/Users/tim-175/repos',
    HOST_REPO_ROOT: '/Users/tim-175/repos',
    WORKTREE_ROOT: '/Users/tim-175/repos/Tree',
  },
  unknown: {
    REPO_ROOT: '/repos',
    HOST_REPO_ROOT: '/repos',
    WORKTREE_ROOT: '/repos/Tree',
  },
};
